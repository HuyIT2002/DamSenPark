...
<div class="white-background-3">
    <div class="container-3">
        <img class="centered-image" src="{{ asset('/public/images/canh-dep/image 288.png') }}" alt="Placeholder Image">
    </div>
    <div class="inner-container-ve-tc">
        <div class="title-warter-show">Nhạc nước Đầm Sen Water show</div>
        <div class="line-warter-show"></div>
        <div class="features-container">
            <div class="feature">
                ...
                <div class="feature-text">Sắp diễn ra</div>
            </div>
            <div class="feature">
                <div class="feature-icon">
    ...
    <div class="main-container-warter-show ">
        <div class="header-container-2">
            <div class="header-title">Mô tả</div>
        </div>
        <div class="description">Sắp ra mắt nhạc nước Đầm Sen Water Show</div>
    </div>
    <div class="container-beauty-scene-warter-show">
        <div class="section-beauty-scene-warter-show">
            <div class="subsection-beauty-scene-warter-show">
                <div class="sub-description-beauty-scene">
                    ...
                    hơn
                    100 mét, kết hợp với khói lửa, công nghệ Laser dance và màn hình khổng lồ hình rẽ quạt, được tạo
                    bằng
                    nước với chiều ngang 40 mét, và chiều cao 20 mét.
                </div>
            </div>
            <div class="image-section-beauty-scene-warter-show">
                <div class="image-container-beauty-scene">
                    <img class="image-beauty-scene-warter-show" src="{{ asset('/public/images/canh-dep/water-show-01.png') }}" />
                </div>
                <div class="caption-beauty-scene">Ảnh minh họa dự án Đầm Sen Water show</div>
            </div>
        </div>
        ...
        <div class="section-beauty-scene-warter-show">
            <div class="subsection-beauty-scene-warter-show">
                <div class="sub-description-beauty-scene">
                    ...
                    nhạc
                    nước Đầm Sen Water Show. Đây được xem là công trình nhạc nước hoàn toàn mới tại TP.HCM, được biểu
                    diễn
                    ngay trên mặt hồ của công viên. </br>
                    Điểm đặc biệt của công trình nhạc nước này, là hình ảnh 3D được chiếu trên màn hình rẽ quạt khổng lồ
                    được tạo bằng nước, rộng 40 mét (cao 20 mét). Hệ thống vòi phun nhạc nước hiện đại trên thế giới
                    hiện
                    nay, được lập trình kỹ lưỡng đến từng giây. Hệ thống khói lửa được tạo ra ngay trên mặt hồ. Đồng
                    thời,
                    hệ thống ánh sáng laser hiện đại được nhập từ Châu Âu, và hệ thống âm thanh với cả chục chiếc loa
                    công
                    suất lớn, đặt xung quanh hồ để tạo hiệu ứng cho người xem.
                </div>
            </div>
            <div class="image-section-beauty-scene-warter-show">
                <div class="image-container-beauty-scene">
                    <img class="image-beauty-scene-warter-show-2" src="{{ asset('/public/images/canh-dep/image 290 (1).png') }}" />
                </div>
                <div class="caption-beauty-scene">Ảnh minh họa dự án Đầm Sen Water show</div>
            </div>
        </div>
        <div class="section-beauty-scene-warter-show">
            <div class="subsection-beauty-scene-warter-show">
                <div class="security-content-warter-show">
                    <span class="security-text-warter-show">
                        Trước đây, CVVH Đầm Sen đã từng có công trình nhạc nước, nhưng với quy mô nhỏ tại khu vực
                    </span>
                    <span class="security-link">quảng trường La Mã</span>
                    <span class="security-text">
                        . Rồi đến tháng tư năm 2019,
                    </span>
                    <span class="security-link">Công ty Cổ phần Dịch vụ Du lịch Phú Thọ</span>
                    <span class="security-text">
                        (Phuthotourist – cơ quan chủ quản của Đầm Sen) đã quyết định đầu tư giai đoạn 1 của dự án nhạc
                        nước trên mặt hồ với
                    </span>
                    <span class="security-link">công trình màn nước laser show.</span>
                    <span class="security-text">
                        Đến nay, giai đoạn 2 của hệ thống đang dần hoàn thiện trong tháng 11. Dự kiến Đầm Sen Water Show
                        sẽ chính thức ra mắt vào đầu tháng 12/2020, để kịp phục vụ du khách vào những sự kiện cuối năm.
                    </span> </br>
                    <span class="security-text">
                        Ban lãnh đạo Phuthotourist cũng đang cân nhắc liệu có cho phép du khách được thưởng thức nhạc
                        nước bằng
                    </span>
                    <span class="security-link">thuyền Pedalo</span>
                    <span class="security-text">
                        trên mặt hồ. Nếu được, chắc chắn đây sẽ là điểm thú vị cho du khách được trải nghiệm cảm giác ở
    ...
    <div class="unique-container-fellow-warter-show">
    ...
    <div class="recommendation-container-warter-show">
    ...
    <div class="chevrons-container-warter-show">
        <div class="custom-chevron-left">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="chevron-left" opacity="0.6">
                    <rect width="64" height="64" rx="32" fill="white" />
                    <path id="Icon" d="M36.333 18.6641L24.333 31.9974L36.333 45.3307" stroke="#259E58" stroke-width="6" stroke-divecap="round" stroke-linejoin="round" />
                </g>
            </svg>
        </div>
