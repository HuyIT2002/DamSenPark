                ...
                <div class="images-wrapper-fellow-vd">
                    ...
                    <div class="image-column-fellow-vd">
                        ...
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/'. $image->image_url) }}" alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">{{ $image->title }}</div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="image-row-vd">
                        ...
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd" src="{{ asset('/public/images/canh-dep/'. $image->image_url) }}" alt="Placeholder Image" />
                ...
                <div class="images-wrapper-fellow">
                    ...
                    <div class="image-column-fellow">
                        ...
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/'. $image->image_url) }}" alt="Placeholder Image">
                            <div class="image-caption-fellow">{{ $image->title }}
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="image-row">
                        ...
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow" src="{{ asset('/public/images/canh-dep/'. $image->image_url) }}" alt="Placeholder Image" />
