...
<div class="white-background-3">
    <div class="container-3">
        <img class="centered-image" src="{{ asset('/public/images/canh-dep/canh-dep-08.png') }}"
        ...
        <div class="section-beauty-scene">
            ...
            <div class="image-row-beauty-scene">
                ...
                <div class="right-image-container-beauty-scene">
                    <img class="right-image-beauty-scene"
                        src="{{ asset('/public/images/canh-dep/canh-dep-03.png') }}" />
                ...
                <div class="images-wrapper-fellow-vd">
                    <div class="custom-chevron-left-fellow-vd">
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="chevron-left" opacity="0.6">
                                ...
                                <path id="Icon" d="M36.333 18.6641L24.333 31.9974L36.333 45.3307" stroke="#005F33"
                    ...
                    <div class="image-column-fellow-vd">
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-001.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">Cảnh làm lễ giỗ quốc tổ tại quảng trường vua Hùng 2019
                            </div>
                        </div>
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-002.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-003.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd"> Nhà hàng Thủy Tạ Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-004.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-005.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-vd">
                            <img class="image-fellow-vd" src="{{ asset('/public/images/canh-dep/canh-dep-006.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow-vd">Xem phim Cinemax 8D tại CVVH Đầm Sen </div>
                        </div>
                    </div>
                        ...
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="chevron-left" opacity="0.6">
                                <rect x="64" y="64" width="64" height="64" rx="32" transform="rotate(180 64 64)"
                                    fill="white" />
                                <path id="Icon" d="M27.667 45.3359L39.667 32.0026L27.667 18.6693" stroke="#005F33"
                                    stroke-width="8" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                        </svg>
                    </div>
                    ...
                    <div class="image-row-vd">
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-006.png') }}" />
                        ...
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-005.png') }}" />
                                <div class="image-overlay-vd"></div>
                            </div>
                        </div>
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-001.png') }}" />
                                <div class="image-overlay-vd"></div>
                            </div>
                        </div>
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-002.png') }}" />
                                <div class="image-overlay-vd"></div>
                            </div>
                        </div>
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-003.png') }}" />
                                <div class="image-overlay-vd"></div>
                            </div>
                        </div>
                        <div class="image-column-vd">
                            <div class="image-container-column-fellow-vd">
                                <img class="image-colum-fellow-vd"
                                    src="{{ asset('/public/images/canh-dep/canh-dep-004.png') }}" />
                                <div class="image-overlay-vd"></div>
                            </div>
                        </div>
                ...
                <div class="images-wrapper-fellow">
                    ...
                    <div class="image-column-fellow">
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-2.jpg') }}"
                                alt="Placeholder Image">
                        ...
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-30.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow"> Nhà hàng Thủy Tạ Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-40.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-50.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-60.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Xem phim Cinemax 8D tại CVVH Đầm Sen </div>
                        </div>
                    </div>
                    ...
                    <div class="image-row">
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-6.jpg') }}" />
                        ...
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-5.jpg') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-2.jpg') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                ...
                <div class="images-wrapper-fellow-cde">
                    ...
                    <div class="image-column-fellow-cde">
                        <div class="image-container-fellow-cde">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-10.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Du khách đến dâng hương nhận lộc bánh chưng từ Đầm Sen
                            </div>
                        </div>
                        <div class="image-container-fellow-cde">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-cd-20.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-cde">
                ...
                <div class="new-section">
                    ...
                    <div class="image-row">
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-60.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-50.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-10.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-20.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-30.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-cd-40.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                ...
                <div class="images-wrapper-fellow-bc">
                    ...
                    <div class="image-column-fellow-bc">
                        <div class="image-container-fellow-bc">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-bc-10.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Làm chiếc bánh chưng khổng lồ tại Đầm Sen năm 2016
                            </div>
                        </div>
                        <div class="image-container-fellow-bc">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-bc-50.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow">Xem phim Cinemax 8D tại CVVH Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-bc">
                            <img class="image-fellow" src="{{ asset('/public/images/canh-dep/image-bc-60.png') }}"
                                alt="Placeholder Image">
                            <div class="image-caption-fellow"> Nhà hàng Thủy Tạ Đầm Sen</div>
                        </div>
                        <div class="image-container-fellow-bc">
                ...
                <div class="new-section">
                    ...
                    <div class="image-row">
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-bc-60.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-bc-50.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
                            <div class="image-container-column-fellow">
                                <img class="image-colum-fellow"
                                    src="{{ asset('/public/images/canh-dep/image-bc-10.png') }}" />
                                <div class="image-overlay"></div>
                            </div>
                        </div>
                        <div class="image-column">
        ...
        <div class="chevrons-container-bc">
            <div class="custom-chevron-left">
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="chevron-left" opacity="0.6">
                        <rect width="64" height="64" rx="32" fill="white" />
                        <path id="Icon" d="M36.333 18.6641L24.333 31.9974L36.333 45.3307" stroke="#259E58"
            ...
            <div class="custom-chevron-right">
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="chevron-left" opacity="0.6">
                        ...
                        <path id="Icon" d="M27.667 45.3359L39.667 32.0026L27.667 18.6693" stroke="#259E58"
                            stroke-width="6" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                </svg>
            </div>
